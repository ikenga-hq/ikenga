			...
			<header className="flex items-start justify-between gap-4">
				<div className="space-y-1">
					...
					<section className="overflow-hidden rounded-lg border border-[var(--border-soft)] bg-card">
						...
						<label className="flex items-center gap-2 px-4 py-3 text-xs text-muted-foreground">
							<input
								type="checkbox"
							...
							/>
							Live-reload the <code>/claude</code> browser on file changes (uses the fs watcher)
						</label>
					</section>
